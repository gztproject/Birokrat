...
final class Version20190923191631 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE incoming_invoice ADD CONSTRAINT FK_95B404A6F1B7C6C FOREIGN KEY (recepient_id) REFERENCES organization (id)');
        ...
        $this->addSql('ALTER TABLE organization_settings ADD received_incoming_invoice_credit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD received_incoming_invoice_debit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD paid_cash_incoming_invoice_credit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD paid_transaction_incoming_invoice_credit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD paid_incoming_invoice_debit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD refunded_incoming_invoice_credit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD refunded_incoming_invoice_debit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD rejected_incoming_invoice_credit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD rejected_incoming_invoice_debit_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE organization_settings ADD CONSTRAINT FK_A5D6267AC174C0E FOREIGN KEY (paid_cash_incoming_invoice_credit_id) REFERENCES konto (id)');
        $this->addSql('ALTER TABLE organization_settings ADD CONSTRAINT FK_A5D6267CB76466A FOREIGN KEY (paid_transaction_incoming_invoice_credit_id) REFERENCES konto (id)');
    ...
    public function postUp(Schema $schema) : void
    {
    	...
    	if($res != null)
    		...
    		{   $sql = "UPDATE organization_settings SET
						...
						received_incoming_invoice_debit_id='".$kontos['400']."',
						paid_cash_incoming_invoice_credit_id='".$kontos['919']."',
						paid_transaction_incoming_invoice_credit_id='".$kontos['110']."',
						paid_incoming_invoice_debit_id='".$kontos['220']."',
						refunded_incoming_invoice_credit_id='".$kontos['400']."',
						refunded_incoming_invoice_debit_id='".$kontos['110']."',
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE organization_settings DROP FOREIGN KEY FK_A5D6267CB76466A');
        ...
        $this->addSql('DROP INDEX IDX_A5D6267CB76466A ON organization_settings');
        ...
        $this->addSql('ALTER TABLE organization_settings DROP received_incoming_invoice_credit_id, DROP received_incoming_invoice_debit_id, DROP paid_cash_incoming_invoice_credit_id, DROP paid_transaction_incoming_invoice_credit_id, DROP paid_incoming_invoice_debit_id, DROP refunded_incoming_invoice_credit_id, DROP refunded_incoming_invoice_debit_id, DROP rejected_incoming_invoice_credit_id, DROP rejected_incoming_invoice_debit_id');
