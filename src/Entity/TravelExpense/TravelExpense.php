...
class TravelExpense extends AggregateBase implements iTransactionDocument
{
    ...
    public function generateLunchTransaction(User $user, LoggerInterface $logger): ?Transaction
    { 
    	$logger->debug("Auto renerating lunch transaction is set to ".$this->organization->getOrganizationSettings()->getAutoCreateLunch());
    	if(!$this->organization->getOrganizationSettings()->getAutoCreateLunch())
    	{
    		$logger->debug("Auto renerating lunch transaction is off. Returning null.");
    		return null;
    	}    		
    	...
    	if($cc == null || $dc == null)
    		...
    		$c->debitKonto = $dc;
    		$c->organization = $this->organization;
    		$c->sum = $this->organization->getOrganizationSettings()->getLunchValue();
    		$c->description = "Autogenerated lunch expense";
    	return new Transaction($c, $user, null);
    }
