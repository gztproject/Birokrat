...
class Bilanca {
	...
	/**
	 * 2 002 A.
	 * DOLGOROČNA SREDSTVA (3+6+7+8+11)
	 */
	public $p002;
	/**
	 * 3 003 I.
	 * Neopredmetena sredstva in dolgoročne aktivne časovne razmejitve (4+5)
	 */
	public $p003;
	/**
	 * 4 004 1.
	...
	/**
	 * 8 019 IV.
	 * Dolgoročne finančne naložbe (9+10)
	 */
	public $p019;
	/**
	 * 9 020 1.
	...
	/**
	 * 12 032 B.
	 * KRATKOROČNA SREDSTVA (13+14+20+23+24)
	 */
	public $p032;
	/**
	 * 13 033 I.
	...
	/**
	 * 20 040 III.
	 * Kratkoročne finančne naložbe (21+22)
	 */
	public $p040;
	/**
	 * 21 041 1.
	...
	/**
	 * 28 056 A.
	 * PODJETNIKOV KAPITAL (29+30+31+32+33+34-35)
	 */
	public $p056;
	/**
	 * 29 058 I.
	 * Začetni podjetnikov kapital
	 */
	public $p058 = 0;
	/**
	 * 30 060a II.
	...
	/**
	 * 36 072 B.
	 * REZERVACIJE IN DOLGOROČNE PASIVNE ČASOVNE RAZMEJITVE (37+38)
	 */
	public $p072;
	/**
	 * 37 073 1.
	...
	/**
	 * 42 085 Č.
	 * KRATKOROČNE OBVEZNOSTI (43+44+45)
	 */
	public $p085;
	/**
	 * 43 086 I.
